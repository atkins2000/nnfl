...
class MultiHeadAttention(nn.Module):
    ...
    def get_layers(self, hid_dim): # 0.5 Marks
        ...
        """
        self.conv_query = nn.Conv1d(hid_dim,hid_dim,3,1,1)
        self.conv_key = nn.Conv1d(hid_dim,hid_dim,3,1,1)
        self.conv_value = nn.Conv1d(hid_dim,hid_dim,3,1,1)
        self.conv_output = nn.Conv1d(hid_dim,hid_dim,1,1,0)
...
class PositionFeedforward(nn.Module):
    ...
    def get_layers(self, hid_dim, feedForward_dim): # 0.5 Mark
        ...
        """
        self.conv1 = nn.Conv1d(hid_dim,feedForward_dim,3,1,1)
        self.conv2 = nn.Conv1d(feedForward_dim,hid_dim,1,1,0)
